...
@Component({
  selector: 'paginadorinv-nav',
  templateUrl: './paginadorinv.component.html',
  styleUrls: ['./paginadorinv.component.css']
})
export class PaginadorinvComponent implements OnInit {
