...
export class DetalleComponent implements OnInit {
  ...
  getTotalFacturas(): void{
    this.cliente.facturas.forEach( factura => {
      this.total += factura.total;
      this.mercadoPago += factura.mercadopago;
    });
    this.cliente.retirosCaja.forEach( retiro => {
        this.retiros += retiro.monto;
    });
    this.efectivo = this.total - this.mercadoPago - this.retiros;
  }
